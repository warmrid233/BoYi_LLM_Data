...
Data analysis file for the Line network with T = 2 treatment

*******************************************************************************/

use Line_T2_All.dta, clear
...
tab gcoordination if ((m2_new == 1)|(m2_esw == 1)) & type == 0
tab gcoordination if ((m2_nsw == 1)|(m2_nes == 1)) & type == 0 
tab gcoordination if m2_ew == 1 & type == 0
tab gcoordination if ((m2_ne == 1)|(m2_es == 1)|(m2_nw == 1)|(m2_sw == 1)) & type == 0 
tab gcoordination if m2_ns == 1 & type == 0 
...
generate stab = ((m1 == m2)&(m1 == action)) if type == 1 | type == 3
...
gen ba_peri = (action == m2_e) if (type == 2)&(m2 ~= m2_e)
replace ba_peri = (action == m2_w) if (type == 0)&(m2 ~= m2_w)
...
gen bba_peri = (action == m2_e) if (type == 2)&(m2 == m2_e)
replace bba_peri = (action == m2_w) if (type == 0)&(m2 == m2_w)
...
gen ind_perN_3 = (action == m2_w) if type == 0 & (m2_nw == 0 & m2_new == 0 & m2_nsw == 0 & m2_unan == 0 & m2_nw_es == 0) 

gen ind_perS_3 = (action == m2_e) if type == 2 & (m2_es == 0 & m2_esw == 0 & m2_nes == 0 & m2_unan == 0 & m2_nw_es == 0) 

collapse (mean) ind_perN_2 ind_perN_3 ind_perS_2 ind_perS_3 (count) nN2 = ind_perN_2 nN3 = ind_perN_3 nS2 = ind_perS_2 nS3 = ind_perS_3 if type == 0 | type == 2, by(subject session type)
