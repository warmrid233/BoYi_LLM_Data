...
Data analysis file for the Star network with T = 5 treatment

*******************************************************************************/


use Star_T5_All.dta, clear
...
gen b3_peri = (m3 == m2_e) if ((type == 0)|(type == 2)|(type == 3))&(m2 ~= m2_e)
gen b4_peri = (m4 == m3_e) if ((type == 0)|(type == 2)|(type == 3))&(m3 ~= m3_e)
gen b5_peri = (m5 == m4_e) if ((type == 0)|(type == 2)|(type == 3))&(m4 ~= m4_e)
gen ba_peri = (action == m5_e) if ((type == 0)|(type == 2)|(type == 3))&(m5 ~= m5_e)

tabstat b2_peri b3_peri b4_peri b5_peri ba_peri, stats(mean sum count)


gen bb2_peri = (m2 == m1_e) if ((type == 0)|(type == 2)|(type == 3))&(m1 == m1_e)
gen bb3_peri = (m3 == m2_e) if ((type == 0)|(type == 2)|(type == 3))&(m2 == m2_e)
gen bb4_peri = (m4 == m3_e) if ((type == 0)|(type == 2)|(type == 3))&(m3 == m3_e)
gen bb5_peri = (m5 == m4_e) if ((type == 0)|(type == 2)|(type == 3))&(m4 == m4_e)
gen bba_peri = (action == m5_e) if ((type == 0)|(type == 2)|(type == 3))&(m5 == m5_e)
...
gen ind_perN_3 = (m3 == m2_e) if type == 0 & (m2_ne == 0 & m2_new == 0 & m2_nes == 0 & m2_unan == 0 & m2_ne_sw == 0) 
...
gen ind_perN_4 = (m4 == m3_e) if type == 0 & (m3_ne == 0 & m3_new == 0 & m3_nes == 0 & m3_unan == 0 & m3_ne_sw == 0) 
...
gen ind_perN_5 = (m5 == m4_e) if type == 0 & (m4_ne == 0 & m4_new == 0 & m4_nes == 0 & m4_unan == 0 & m4_ne_sw == 0) 
...
gen ind_perN_6 = (action == m5_e) if type == 0 & (m5_ne == 0 & m5_new == 0 & m5_nes == 0 & m5_unan == 0 & m5_ne_sw == 0) 
...
collapse (mean) ind_perN_2 ind_perN_3 ind_perN_4 ind_perN_5 ind_perN_6 ind_perS_2 ind_perS_3 ind_perS_4 ind_perS_5 ind_perS_6 ind_perW_2 ind_perW_3 ind_perW_4 ind_perW_5 ind_perW_6 (count) nN_2 = ind_perN_2 nN_3 = ind_perN_3 nN_4 = ind_perN_4 nN_5 = ind_perN_5 nN_6 = ind_perN_6 nS_2 = ind_perS_2 nS_3 = ind_perS_3 nS_4 = ind_perS_4 nS_5 = ind_perS_5 nS_6 = ind_perS_6 nW_2 = ind_perW_2 nW_3 = ind_perW_3 nW_4 = ind_perW_4 nW_5 = ind_perW_5 nW_6 = ind_perW_6, by(subject session type)
